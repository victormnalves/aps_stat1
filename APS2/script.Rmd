...
```{r}
grid.arrange(arrangeGrob(cor_pi_u_60, cor_pi_u_70, cor_pi_u_80,
                         cor_pi_u_90, cor_pi_u_00, cor_pi_u_10,
                         ncol=2), 
              top = grid::textGrob('Correlação entre desemprego e inflação da década de 60 à 10', x = 0, hjust = -.18))
```
